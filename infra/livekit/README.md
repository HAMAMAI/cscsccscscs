...
Один узел LiveKit с TURN/UDP на `443`, TURN/TLS на `5349` и изолированным HTTPS Caddy на `8443`. HAProxy публикует API и WebSocket-сигналинг call-домена на обычном HTTPS `443/TCP`.
